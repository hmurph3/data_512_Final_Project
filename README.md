...
* **Integrated Library Systems (ILS) Data Dictionary.csv**: This is the entier Data dictionary used to decifer codes like Item Locoation, Item Type, etc.  For licencing information see ** The Data** section below.
